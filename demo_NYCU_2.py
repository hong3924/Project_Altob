...
LastEditTime: 2022-06-06 13:00:37
...
def track_cap(model, input_path, output_path, camera):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--source', type=str, default='0', help='foreground source')
    ...
    track_cap(args.model, args.source, args.output, args.camera)